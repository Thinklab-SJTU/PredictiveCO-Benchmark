...
python rethink_exp/main_results.py --problem=portfolio --opt_model lodl     --solver cvxpy --n_epochs ${EPOCHS} --gpu ${GPU} --method_path "openpto/config/models/lodl50k.yaml"
