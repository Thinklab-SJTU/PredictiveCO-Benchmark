...
python rethink_exp/main_results.py --problem=bipartitematching --opt_model ce       --solver cvxpy --n_epochs ${EPOCHS} --gpu ${GPU} --instances 20 --testinstances 6 --losslr 0.01 --n_layers 1 --n_hidden 32
