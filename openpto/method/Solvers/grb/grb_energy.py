...
class ICONGrbSolver(optGrbSolver):
    def __init__(self,nbMachines,nbTasks,nbResources,MC,U,D,E,L,P,idle,up,down,q,reset=True,presolve=True,relax=False,
...
def ICON_scheduling(price,nbMachines,nbTasks,nbResources,MC,U,D,E,L,P,idle,up,down,q,
    ...
    verbose=False,scheduling=False,warmstart=None, timelimit=None,**h):
