...
python rethink_exp/main_results.py --problem=budgetalloc --opt_model nce      --solver neural --n_epochs ${EPOCHS} --gpu ${GPU}
...
# prediction + decision
python rethink_exp/main_results.py --problem=budgetalloc --opt_model blackbox --solver nerual --prefix "ptr-ftn" --n_ptr_epochs 50 --n_epochs 50 --gpu ${GPU}
python rethink_exp/main_results.py --problem=budgetalloc --opt_model identity --solver neural --prefix "ptr-ftn" --n_ptr_epochs 50 --n_epochs 50 --gpu ${GPU}
