...
# python rethink_exp/main_results.py --problem=energy --opt_model  --solver gurobi --n_epochs ${EPOCHS} --gpu ${GPU}
...
# # problem size:
# python rethink_exp/main_results.py --problem=energy --opt_model mse --solver gurobi --n_epochs 30 --gpu ${GPU} \
