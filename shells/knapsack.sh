...
# python rethink_exp/main_results.py --problem=knapsack --opt_model  --solver gurobi --n_epochs ${EPOCHS} --gpu ${GPU}

# prediction + decision
python rethink_exp/main_results.py --problem=knapsack --opt_model blackbox --solver gurobi --n_ptr_epochs 50 --n_epochs 10 --gpu ${GPU}
python rethink_exp/main_results.py --problem=knapsack --opt_model identity --solver gurobi --n_ptr_epochs 50 --n_epochs 10 --gpu ${GPU}

# # problem size:
# python rethink_exp/main_results.py --problem=knapsack --opt_model mse --solver gurobi --n_epochs 30 --gpu ${GPU} \
