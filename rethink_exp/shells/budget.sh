...
python rethink_exp/main_results.py --problem=budgetalloc --opt_model mse      --solver neural --n_epochs ${EPOCHS} --gpu 0

# Decisoin-focused learning
python rethink_exp/main_results.py --problem=budgetalloc --opt_model dfl      --solver neural --n_epochs ${EPOCHS} --gpu 0
...
python rethink_exp/main_results.py --problem=budgetalloc --opt_model lodl     --solver neural --n_epochs ${EPOCHS} --gpu 0
